...
```bash
git clone https://github.com/whitevshadow/Free-Claude-code.git
cd free-claude-code
cp .env.example .env
```
...
```bash
uv tool install git+https://github.com/whitevshadow/Free-Claude-code.git
...
uv tool install "free-claude-code[voice_local] @ git+https://github.com/whitevshadow/Free-Claude-code.git"
uv tool install "free-claude-code[voice] @ git+https://github.com/whitevshadow/Free-Claude-code.git"
uv tool install "free-claude-code[voice,voice_local] @ git+https://github.com/whitevshadow/Free-Claude-code.git"
```
...
- Report bugs or suggest features via [Issues](https://github.com/whitevshadow/Free-Claude-code/issues)
